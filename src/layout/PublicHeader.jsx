...
const PublicHeader = () => {
    ...
    const activeLink = "text-white bg-cyan-700 rounded-md px-3 py-2 text-sm font-medium";
    const inactiveLink = "text-cyan-50 hover:text-white hover:bg-cyan-500 rounded-md px-3 py-2 text-sm font-medium";
            ...
            <div className="container mx-auto px-4">
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex md:items-center md:space-x-3">
                        ...
                        <NavLink to="/companies" className={({ isActive }) => (isActive ? activeLink : inactiveLink)}>Companies</NavLink>
                        <NavLink to="/contact" className={({ isActive }) => (isActive ? activeLink : inactiveLink)}>Contact</NavLink>
                        <div className="h-6 border-l border-cyan-300"></div>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center md:hidden">
                        <button
                            ...
                            className="inline-flex items-center justify-center p-2 rounded-md text-cyan-100 hover:text-white hover:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                        >
            ...
            {isOpen && (
                <div className="md:hidden">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <NavLink to="/companies" className={({ isActive }) => `block ${isActive ? activeLink : inactiveLink}` }>Companies</NavLink>
