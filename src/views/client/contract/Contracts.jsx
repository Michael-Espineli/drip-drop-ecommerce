...
function Contracts () { 
    ...
    useEffect(() => {
        (async () => {
            ...
            try{
                //Accepted
                let q = query(collection(db, 'contracts'),where('status','==','Pending'),where('clientId','==',user.uid));
                ...
                //Pending
                let q2 = query(collection(db, 'contracts'),where('status','==','Accepted'),where('clientId','==',user.uid));
                        ...
                        contractsAccepted?.map( contract => (
                                <tr key={contract.id}>
                                    ...
                                    <td>
                                        ...
                                        to={`/contracts/contract/${contract.id}`}>Detail</Link>
                                    </td>
                                </tr>
