            ...
            <div className="pt-24">
                ...
                <header className="bg-cyan-600 text-white py-20">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="mt-4 text-lg text-cyan-50">We're on a mission to simplify the pool service industry.</p>
                    </div>
                </header>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid md:grid-cols-2 gap-16">
                            <div className="text-center md:text-left">
                                <LightBulbIcon className="h-12 w-12 text-cyan-500 mx-auto md:mx-0 mb-4" />
                            ...
                            <div className="text-center md:text-left">
                                <BuildingOffice2Icon className="h-12 w-12 text-cyan-500 mx-auto md:mx-0 mb-4" />
