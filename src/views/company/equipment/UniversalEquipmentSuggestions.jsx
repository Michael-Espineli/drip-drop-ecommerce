...
const suggestionToDraft = (suggestion = {}) => ({
  ...
  modelId: suggestion.modelId || suggestion.universalEquipmentId || "",
  universalEquipmentId: suggestion.universalEquipmentId || suggestion.modelId || "",
  manualPdfLink: suggestion.manualPdfLink || "",
});
...
const UniversalEquipmentSuggestions = () => {
  ...
  const filteredSuggestions = useMemo(() => {
    ...
    return suggestions
      ...
      .sort((left, right) => {
        const statusRank = { New: 0, Reviewed: 1, Reconciled: 2, Dismissed: 3 };
