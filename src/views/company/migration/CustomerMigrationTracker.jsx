...
function CustomerMigrationTracker() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-3 py-5 sm:px-4 lg:px-5">
      ...
      <section className="mb-5 rounded-md border border-blue-100 bg-blue-50 p-5 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-xs font-bold uppercase tracking-wide text-blue-700">Product Catalog Reconciliation</p>
            <h2 className="mt-1 text-base font-semibold text-blue-950">Reconcile Vendor Items with Products</h2>
            <p className="mt-1 max-w-4xl text-sm leading-6 text-blue-800">
              Convert existing vendor-specific database items into the new Product Catalog layer, or connect them to Products that already exist.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link
              to="/company/product-catalog/reconciliation"
              className="inline-flex items-center justify-center gap-2 rounded-md bg-blue-700 px-3 py-2 text-sm font-semibold text-white transition hover:bg-blue-800"
            >
              <FaFileInvoiceDollar className="h-3.5 w-3.5" />
              Open Reconciliation
            </Link>
            <Link
              to="/company/product-catalog"
              className="inline-flex items-center justify-center rounded-md border border-blue-200 bg-white px-3 py-2 text-sm font-semibold text-blue-800 transition hover:bg-blue-100"
            >
