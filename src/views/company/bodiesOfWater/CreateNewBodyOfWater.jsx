...
const CreateNewBodyOfWater = () => {
    const {customerId,serviceLocationId} = useParams();
        ...
        <div className='px-2 md:px-7 py-5'>
            ...
            <div className='w-full bg-[#747e79] p-4 rounded-md'>
                <div className='left-0 w-full justify-between'>
                    <h2>Create New Body Of Water {customerId} {serviceLocationId}</h2>
    ...
    export default CreateNewBodyOfWater;
