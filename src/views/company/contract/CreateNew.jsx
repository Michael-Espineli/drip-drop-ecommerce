        ...
        (async () => {
            ...
            try{
                let q;
                    ...
                    q = query(collection(db, 'companies',recentlySelectedCompany,'serviceLocations'), where('customerId','==',selectedOption2.id));
            ...
            <div className='py-2'>
                <div>
                    <Link to='/company/contracts'>
                        <div className='flex bg-[#454b39] rounded-md py-1 px-2 text-[#d0d2d6] justify-start items-center gap-3'>
                            <FaChevronLeft />
                            <p>
