...
const FormInput = ({ label, type = 'text', value, onChange, placeholder, required = true }) => (
    <div>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await setDoc(contractRef, {
                ...
                status: 'Pending',
                dateSent: new Date(),
                // Fields for one-time contracts
                postingType: 'DIRECT', // As it is a direct offer
                receiverAcceptance: 'Pending', // Initial state
                senderAcceptance: 'Pending' // Or 'Accepted' if creator auto-accepts
            });
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200 space-y-6">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                        <h2 class="text-xl font-bold text-gray-800 mb-4">Recipient</h2>
                    ...
                    <div className="border-b border-gray-200 pb-6">
                        <h2 class="text-xl font-bold text-gray-800 mb-4">Contract Details</h2>
                    ...
                    <div>
                         <h2 class="text-xl font-bold text-gray-800 mb-4">Terms & Notes</h2>
