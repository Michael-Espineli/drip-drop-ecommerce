...
export const allNav = [
    ...
    { id: 69, title: 'Service Agreements', icon: <FaFileContract />, role: 'Company', path: '/company/sales/agreements', category: 'Finance', permissionIds: ['400', SERVICE_AGREEMENTS_PERMISSION_ID], featureFlagId: 'feature_flag_004' },
